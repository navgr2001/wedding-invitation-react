  ...
  useEffect(() => {
    ...
    (() => {
      ...
      /* -------------------------------------------------
         CONFIG
         ------------------------------------------------- */
      const APPS_SCRIPT_WEBAPP_URL = weddingContent.rsvp.formAction;
      const GOOGLE_SHEET_ID = weddingContent.sheets.googleSheetId;
      const GOOGLE_SHEET_TAB_NAME = weddingContent.sheets.rsvpTabName;
      const SEATING_ORDER_SHEET_TAB_NAME = weddingContent.sheets.seatingTabName;
