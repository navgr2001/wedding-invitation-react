    ...
    <>
          ...
          <div className="weddingFooter__grid">
            <div className="weddingFooter__brand">
              <div className="weddingFooter__logo">
                ...
                <span className="weddingFooter__logoText">S &amp; D</span>
              </div>

              <p className="weddingFooter__description">
      ...
      <style>{`
        ...
        .weddingFooter {
          ...
          overflow: hidden;
          width: 100%;
          padding: clamp(68px, 7vw, 80px) 0 36px;
          color: #ffffff;
          background:
            radial-gradient(
              760px 310px at 50% -10%,
              rgba(89, 113, 160, 0.36),
              transparent 68%
            ),
            linear-gradient(180deg, #101a2f 0%, #081225 58%, #061020 100%);
        }

        .weddingFooter::before {
          content: "";
          position: absolute;
          inset: 0;
          pointer-events: none;
        ...
        .weddingFooter__grid {
          display: grid;
          grid-template-columns: 1.22fr 0.85fr 1.25fr 1.35fr;
        ...
        .weddingFooter__links,
        .weddingFooter__details,
        .weddingFooter__contact {
          display: grid;
          gap: 15px;
        }

        .weddingFooter__links a,
        .weddingFooter__details p,
        .weddingFooter__contactItem {
          margin: 0;
          color: rgba(255, 255, 255, 0.9);
          font-size: 1.08rem;
          font-weight: 500;
        ...
        .weddingFooter__contactItem:hover {
          color: #d8b78c;
          transform: translateX(3px);
        }

        .weddingFooter__contactIcon {
          width: 39px;
          height: 39px;
          display: inline-grid;
          place-items: center;
        ...
        .weddingFooter__contactText {
          display: inline-block;
          white-space: nowrap;
        }

        .weddingFooter__bottom {
          margin-top: clamp(64px, 8vw, 82px);
          padding-top: 26px;
          border-top: 1px solid rgba(216, 183, 140, 0.5);
          text-align: center;
        }
